    ...
    <div class="container">
      ...
      <div class="row event_box">
        ...
        <div class="col-lg-4 col-md-6 align-self-center mb-30 event_outer col-md-6 wordpress development">
          <div class="events_item">
            <div class="thumb">
              <a href="#"><img src="{{ asset('frontend/assets/images/course-05.jpg')}}" alt=""></a>
              <span class="category">Wordpress</span>
        ...
        <div class="col-lg-4 col-md-6 align-self-center mb-30 event_outer col-md-6 wordpress design">
          <div class="events_item">
            <div class="thumb">
              <a href="#"><img src="{{ asset('frontend/assets/images/course-06.jpg')}}" alt=""></a>
              <span class="category">Webdesign</span>
    ...
    <div class="container">
      <div class="row">
        ...
        <div class="col-lg-3 col-md-6">
          <div class="team-member">
            <div class="main-content">
              <img src="{{ asset('frontend/assets/images/member-02.jpg')}}" alt="">
        ...
        <div class="col-lg-3 col-md-6">
          <div class="team-member">
            <div class="main-content">
              <img src="{{ asset('frontend/assets/images/member-03.jpg')}}" alt="">
        ...
        <div class="col-lg-3 col-md-6">
          <div class="team-member">
            <div class="main-content">
              <img src="{{ asset('frontend/assets/images/member-04.jpg')}}" alt="">
