                        ...
                        <div class="action justify-content">
                            <div class="dropdown">
                                ...
                                <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="moreAction1">
                                    <li>
                                        <a href="{{ route('datapusat.edit', $data->id) }}" class="dropdown-item">
                                            <i class="mdi mdi-pencil"></i> Edit
                                        </a>
                                    </li>
                                    <li>
                                        <a href="{{ route('datapusat.show', $data->id) }}" class="dropdown-item">
                                    ...
                                    <li>
                                        <form action="{{ route('datapusat.destroy', $data->id) }}" method="post" style="display:inline;">
                                            @csrf
                                            @method('DELETE')
