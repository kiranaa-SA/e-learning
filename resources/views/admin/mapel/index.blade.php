...
<div class="container">
    ...
    <form action="{{ route('mapel.index') }}" method="get" class="d-flex" style="max-width: 300px;">
                    ...
                    <div class="table-responsive">
                      <table class="table" id="tabelPetugas">
                        <thead>
                          <tr>
                            <th scope="col">No</th>
                            <th scope="col">Mapel<i class="lni lni-arrows-vertical"></i></th>
                            <th scope="col">Kode Mapel<i class="lni lni-arrows-vertical"></i></th>
                                        ...
                                        <div class="action justify-content">
                                            <div class="dropdown">
                                                ...
                                                <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="moreAction1">
                                                    <li>
                                                        <a href="{{ route('mapel.edit', $data->id) }}" class="dropdown-item">
